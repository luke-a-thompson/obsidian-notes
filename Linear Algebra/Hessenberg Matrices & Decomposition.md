Schur's theorem: Every square matrix $A$ is [[Similar Matrices|similar]] to one in the upper Hessenberg form. Hence, the Hessenberg form of $A$ has the same eigenvalues as $A$.
